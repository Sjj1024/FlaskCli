...
from src import redis_store, constants, db
from src.models import User
from src.moduls.user import passport_blu
from src.utils.captcha.captcha import captcha
from src.utils.common_util import send_email, create_token
...
def login():
    ...
    token = create_token(121212)
    return jsonify(code=200, message="登陆成功", data={"token": token})


@passport_blu.route("/info", methods=["GET"])
def info():
    user_info = {"name": "1024小神", "avatar": "https://avatars.githubusercontent.com/u/48399687?v=4"}
