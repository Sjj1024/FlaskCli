...
def get_caoliu_commit_py(user_info):
    caoliu_commit_py = """import json
import time
import requests
...
if __name__ == '__main__':
    one_commit()
    """
    res_commit_py = caoliu_commit_py + caoliu_user_temp
...
if __name__ == '__main__':
    ...
    # }
    # res = get_caoliu_commit_py(user)
    res = get_caoliu_task_yml("jiangshang.py")
    print(res)
